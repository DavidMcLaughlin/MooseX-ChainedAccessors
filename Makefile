# This Makefile is for the MooseX::ChainedAccessors extension to perl.
#
...
#     AUTHOR => q[David McLaughlin <david@dmclaughlin.com>]
#     DIR => []
#     DISTNAME => q[MooseX-ChainedAccessors]
#     NAME => q[MooseX::ChainedAccessors]
#     NO_META => q[1]
#     PL_FILES => {  }
...
NAME_SYM = MooseX_ChainedAccessors
VERSION = 0.01
...
MAKE = dmake
FULLEXT = MooseX\ChainedAccessors
BASEEXT = ChainedAccessors
PARENT_NAME = MooseX
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
...
TO_INST_PM = lib/Moose/Meta/Attribute/Custom/Trait/Chained.pm \
	lib/MooseX/ChainedAccessors/Accessor.pm \
	lib/MooseX/Traits/Attribute/Chained.pm

PM_TO_BLIB = lib/MooseX/ChainedAccessors/Accessor.pm \
	blib\lib\MooseX\ChainedAccessors\Accessor.pm \
	lib/MooseX/Traits/Attribute/Chained.pm \
	blib\lib\MooseX\Traits\Attribute\Chained.pm \
	lib/Moose/Meta/Attribute/Custom/Trait/Chained.pm \
...
DISTNAME = MooseX-ChainedAccessors
DISTVNAME = MooseX-ChainedAccessors-0.01
...
ChainedAccessors.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"MooseX::ChainedAccessors\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <AUTHOR>David McLaughlin &lt;david@dmclaughlin.com&gt;</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')" -- \
	  lib/MooseX/ChainedAccessors/Accessor.pm blib\lib\MooseX\ChainedAccessors\Accessor.pm \
	  lib/MooseX/Traits/Attribute/Chained.pm blib\lib\MooseX\Traits\Attribute\Chained.pm \
	  lib/Moose/Meta/Attribute/Custom/Trait/Chained.pm blib\lib\Moose\Meta\Attribute\Custom\Trait\Chained.pm 
...
# End.
# Postamble by Module::Install 0.88
